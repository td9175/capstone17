...
class YelpHealthServiceRequest extends CI_Controller {
   ...
   * @return   The JSON response from the request
   */
   function search($bearer_token, $categories, $term, $location, $radius, $searchLimit) {
   ...
   */
   function query_api() {
     ...
     $location = $this->input->post('location');
		 ...
		 $searchLimit = $this->input->post('searchLimit');

     // Get the bearer token
     $bearer_token = $this->obtain_bearer_token();

     // Send a request to the search method
     $response = json_decode($this->search($bearer_token, $categories, $term, $location, $radius, $searchLimit));
