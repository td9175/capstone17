...
var IonicEnvironmentPlugin = (function () {
    function IonicEnvironmentPlugin(context, parsedDeepLinkConfigs) {
        this.context = context;
        this.parsedDeepLinkConfigs = parsedDeepLinkConfigs;
    }
    IonicEnvironmentPlugin.prototype.apply = function (compiler) {
        ...
        compiler.plugin('context-module-factory', function (contextModuleFactory) {
            var webpackDeepLinkModuleDictionary = convertDeepLinkConfigToWebpackFormat(_this.parsedDeepLinkConfigs);
